        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.register_username),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("mihai23"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.lightview_name),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("Lumina"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.lightview_brightness),
                        childAtPosition(
                                ...
                                7),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("255"), closeSoftKeyboard());
